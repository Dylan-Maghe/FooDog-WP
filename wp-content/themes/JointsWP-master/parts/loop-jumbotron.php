<?php
	...
	<div class="content">
		...
		<div class="inner-content grid-x grid-padding-x grid-container ">
			...
			<div class="jumbotron grid-x grid-padding-x cell medium-12 large-12 ">
			    <?php $i = 0; while( $popular_posts_loop->have_posts() && $i < 1 ): $popular_posts_loop->the_post(); ?>
				<div class="jumbotron-left cell small-12 medium-12 large-6">
				...
				<div class="jumbotron-right grid-x grid-padding-x cell small-12 medium-12 large-6">	
				<?php $i = 0; while ($popular_posts_loop->have_posts() && $i < 4) : $popular_posts_loop->the_post(); ?>	
				<article class="article-dylan cell  small-6 medium-6 large-6">
					<?php if ( has_post_thumbnail()) : ?>
					<a class="img2-jumbotron" href=<?php the_permalink(); ?> title= »<?php the_title_attribute(); ?> » ><?php the_post_thumbnail('large'); ?></a>
